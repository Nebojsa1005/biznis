...
import static com.serveup.web.rest.TestUtil.sameNumber;
...
import com.serveup.repository.RatingRepository;
...
class RatingResourceIT {
    ...
    void createRating() throws Exception {
        ...
        assertThat(testRating.getRating()).isEqualByComparingTo(DEFAULT_RATING);
    }
    ...
    void getAllRatings() throws Exception {
        ...
        restRatingMockMvc
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(rating.getId().toString())))
    ...
    void getNonExistingRating() throws Exception {
        // Get the rating
        restRatingMockMvc.perform(get(ENTITY_API_URL_ID, UUID.randomUUID().toString())).andExpect(status().isNotFound());
    }
    ...
    void putExistingRating() throws Exception {
        ...
        Rating testRating = ratingList.get(ratingList.size() - 1);
        assertThat(testRating.getRating()).isEqualByComparingTo(UPDATED_RATING);
    }
    ...
    void deleteRating() throws Exception {
        ...
        // Delete the rating
        restRatingMockMvc
            .perform(delete(ENTITY_API_URL_ID, rating.getId().toString()).accept(MediaType.APPLICATION_JSON))
