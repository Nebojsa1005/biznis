...
describe('AppUser Management Detail Component', () => {
      ...
      providers: [
        {
          ...
          useValue: { data: of({ appUser: { id: '9fec3727-3421-4967-b213-ba36557ca194' } }) },
        },
      ],
    })
  ...
  describe('OnInit', () => {
    it('Should load appUser on init', () => {
      ...
      // THEN
      expect(comp.appUser).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
    });
  });
