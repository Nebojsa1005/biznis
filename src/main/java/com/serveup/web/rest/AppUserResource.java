...
/**
 * REST controller for managing {@link com.serveup.domain.AppUser}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class AppUserResource {
    ...
    public ResponseEntity<AppUser> updateAppUser(@PathVariable(value = "id", required = false) final UUID id, @RequestBody AppUser appUser)
    ...
    public ResponseEntity<AppUser> partialUpdateAppUser(
        ...
        Optional<AppUser> result = appUserRepository
            ...
            .map(existingAppUser -> {
                ...
                if (appUser.getImageContentType() != null) {
                    existingAppUser.setImageContentType(appUser.getImageContentType());
                }
                if (appUser.getAvgSalary() != null) {
                    existingAppUser.setAvgSalary(appUser.getAvgSalary());
                }
                if (appUser.getAvgRating() != null) {
                    existingAppUser.setAvgRating(appUser.getAvgRating());
                }
                if (appUser.getIsActive() != null) {
                    existingAppUser.setIsActive(appUser.getIsActive());
                }
                if (appUser.getUserType() != null) {
                    existingAppUser.setUserType(appUser.getUserType());
                }
    ...
    public ResponseEntity<AppUser> getAppUser(@PathVariable UUID id) {
