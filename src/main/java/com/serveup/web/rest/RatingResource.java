...
/**
 * REST controller for managing {@link com.serveup.domain.Rating}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class RatingResource {
    ...
    public ResponseEntity<Rating> updateRating(@PathVariable(value = "id", required = false) final UUID id, @RequestBody Rating rating)
