...
/**
 * REST controller for managing {@link com.serveup.domain.Comment}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CommentResource {
    ...
    public ResponseEntity<Comment> updateComment(@PathVariable(value = "id", required = false) final UUID id, @RequestBody Comment comment)
